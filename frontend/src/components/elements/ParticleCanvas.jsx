...
//     // 3D wave effect on the y-position
//     p.y += sin(freq * (p.x + uTime)) * amp;
//     p.y += cos(freq * (p.z + uTime)) * amp;

//     // Vary point size for dynamic depth
//     s += sin(freq * (p.x + uTime)) + cos(freq * (p.z + uTime));
...
//     // Cleanup existing particles if any
...
//     };
//   }, [initThree, animate, handleResize]);
