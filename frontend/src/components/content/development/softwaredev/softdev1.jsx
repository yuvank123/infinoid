...
import sampleImg from '../../../../../public/images/softwaredev.webp'; // Replace with relevant software image if needed
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Expert custom software development services tailored to your business needs." />
            </Helmet>
            ...
            <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 py-10 sm:py-16 md:py-50 bg-black overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-xl w-full gap-12 lg:gap-20 md:mb-40">
                    <div className="flex-1 text-center md:text-left space-y-6">
                        ...
                        >
                            Building <span className="text-purple-300">Smart & Scalable</span> Software Solutions
                        </h1>
                        ...
                        >
                            We build scalable, secure, and high-performing custom software tailored to your business goals.
                        </p>
