...
import sampleImg from '../../../../../public/images/microimage.png'; // Add a relevant microservices/serverless image
...
const MSS1 = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Microservices & Serverless Architecture</title>
                <meta
                    name="description"
                    content="Build scalable, modular applications using microservices and serverless architecture. Enable rapid deployment, cost-efficiency, and high resilience in your systems."
                />
            </Helmet>
            ...
            <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 py-10 sm:py-16 md:py-40 bg-black overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-xl w-full gap-12 lg:gap-20 md:mb-40">
                    <div className="flex-1 text-center md:text-left space-y-6">
                        ...
                        >
                            Power Modern Apps with <span className="text-purple-300">Microservices & Serverless</span> Architecture
                        </h1>
                        ...
                        >
                            Leverage loosely coupled services and event-driven serverless computing to build fault-tolerant, scalable, and efficient cloud-native applications.
                        </p>
                        ...
                        >
                            Discover Microservices Strategy
                        </a>
                    </div>
                ...
                <div className="h-[300px] w-full hidden lg:flex flex-1 items-center justify-center border-20 border-gray-900 rounded-full bg-gradient-to-r from-gray-900 via-gray-950 to-black backdrop-blur-2xl inset-shadow-sm inset-shadow-black overflow-hidden">
                    <h1 className="relative font-bold text-7xl text-white unbounded left-100 opacity-80 animate-pulse">
                        Modular. Scalable. Stateless.
                    </h1>
                    <motion.img
                        src={sampleImg}
                        alt="Microservices Visual"
                        style={{ rotate, x: xOffset }}
