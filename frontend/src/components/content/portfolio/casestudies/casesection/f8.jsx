      ...
      <section className="py-5 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-4">
            Infinoid Technologies pvt. ltd. developed a powerful and intuitive CRM platform that centralizes customer interactions, automates sales processes, and empowers teams with data-driven insights. Tailored for growing businesses, the system streamlines operations from lead capture to client retention.
          </p>
          <p className="text-xl italic text-blue-300">
            "Turning relationships into revenue — Infinoid Technologies pvt. ltd. CRM unlocks smarter customer engagement."
          </p>
        </div>
        {/* Overview Image */}
