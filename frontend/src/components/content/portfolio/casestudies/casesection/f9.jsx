      ...
      <section className="py-5 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-4">
            Infinoid Technologies pvt. ltd. designed a complete E-Commerce platform tailored for artisan bakeries and home-based dessert businesses. With elegant UI and seamless backend automation, this system transforms how bakeries handle online orders, deliveries, and product showcases.
          </p>
          <p className="text-xl italic text-blue-300">
            "From oven to doorstep — sell sweet, sell smart with Infinoid Technologies pvt. ltd."
          </p>
        </div>
