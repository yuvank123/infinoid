      ...
      <section className="py-5 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-4">
            Infinoid Technologies pvt. ltd. created a smart and secure Visitor Management System (VMS) that digitizes the check-in process, enhances workplace security, and improves guest experiences. Designed for organizations of all sizes, the system seamlessly integrates with existing infrastructure and supports real-time monitoring and visitor analytics.
          </p>
          <p className="text-xl italic text-blue-300">
            "Redefining first impressions — Infinoid Technologies pvt. ltd. delivers a smarter, safer welcome."
          </p>
        </div>
        {/* Overview Image */}
