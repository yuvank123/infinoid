...
import sampleImg from '../../../../../public/images/crmerp.webp'; // Replace with relevant CRM/ERP image
...
const CRMERP1 = () => {
    ...
    return (
        <>
            <Helmet>
                <title>CRM & ERP API Integrations</title>
                <meta
                    name="description"
                    content="Seamless CRM and ERP API integration services to automate workflows, unify data, and boost enterprise productivity."
                />
            </Helmet>
            ...
            <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 py-10 sm:py-16 md:py-40 bg-black overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-xl w-full gap-12 lg:gap-20 md:mb-40">
                    <div className="flex-1 text-center md:text-left space-y-6">
                        ...
                        >
                            Smart <span className="text-purple-300">CRM & ERP Integrations</span> for Seamless Business Flow
                        </h1>
