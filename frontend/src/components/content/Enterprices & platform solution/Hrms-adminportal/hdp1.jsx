...
import hrmsImg from '../../../../../public/images/hrmsimage.webp'; // Update path if using different image

const HRMSAdminPortal = () => {
    ...
    return (
        <>
            <Helmet>
                <title>HRMS & Admin Portal Integrations</title>
                <meta
                    name="description"
                    content="Robust HRMS and Admin Portal integration to manage workforce operations, track analytics, and automate organizational workflows."
                />
            </Helmet>
            ...
            <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 py-10 sm:py-16 md:py-40 bg-black overflow-hidden">
                ...
                <div className="absolute inset-0 lg:hidden z-0 opacity-20 flex flex-col justify-center items-center">
                    <motion.img
                        src={hrmsImg}
                        alt="HRMS Admin Portal Integration"
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-xl w-full gap-12 lg:gap-20 md:mb-40">
                    <div className="flex-1 text-center md:text-left space-y-6">
                        ...
                        >
                            Intelligent <span className="text-purple-300">HRMS & Admin Portal</span> for Streamlined Operations
                        </h1>
                        ...
                        >
                            Integrate your Human Resource Management System with admin operations to automate workflows, centralize employee data, and boost organizational productivity.
                        </p>
                    ...
                    <div className="hidden lg:flex flex-1 items-start justify-start border-20 border-gray-900 rounded-full bg-gradient-to-r from-gray-900 via-gray-950 to-black backdrop-blur-2xl inset-shadow-sm inset-shadow-black overflow-hidden">
                        <motion.img
                            ...
                            alt="HRMS Admin Portal Integration"
                            style={{ rotate, x: xOffset }}
                            className="relative border border-gray-800 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-[300px] object-cover rounded-full bg-gradient-to-br from-black via-black to-gray-800 py-8 m-2 shadow-[0_35px_35px_rgba(0,0,0,0.25)]"
                        />
                    </div>
                </div>
                ...
                <div className="h-[300px] w-full hidden lg:flex flex-1 items-center justify-center border-20 border-gray-900 rounded-full bg-gradient-to-r from-gray-900 via-gray-950 to-black backdrop-blur-2xl inset-shadow-sm inset-shadow-black overflow-hidden">
                    ...
                    <motion.img
                        src={hrmsImg}
                        alt="HRMS Admin Visual"
                        style={{ rotate, x: xOffset }}
                        className="relative border border-gray-800 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-[300px] object-cover rounded-full bg-gradient-to-br from-black via-black to-gray-800 py-8 m-2 -left-300 shadow-[0_35px_35px_rgba(0,0,0,0.25)]"
                    />
                    <motion.img
                        src={hrmsImg}
                        alt="HRMS Admin Visual"
                        style={{ rotate, x: xOffset }}
                        className="relative border border-gray-800 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-[300px] object-cover rounded-full bg-gradient-to-br from-black via-black to-gray-800 py-8 m-2 -left-100 shadow-[0_35px_35px_rgba(0,0,0,0.25)]"
                    />
                </div>
            </div>
        </>
...
export default HRMSAdminPortal;
