...
const hrmsStack = [
    {
        ...
        icon: FiUsers,
        items: ["Profile Records", "Attendance", "Leave Tracker", "Employee Lifecycle", "Team Directory"]
    },
    {
        title: "Payroll & Compensation",
        icon: FiDollarSign,
        items: ["Salary Processing", "Bonuses", "Reimbursements", "Payslips", "Deductions"]
    },
    {
        title: "Performance & Reviews",
        icon: FiBarChart2,
        items: ["Goal Setting", "Appraisals", "Feedback Loops", "Review Cycles", "KPI Tracking"]
    }
];

// 🔸 Admin Portal Stack Only
const adminPortalStack = [
    {
        title: "Admin Controls",
        icon: FiServer,
        items: ["Role Management", "Permissions", "User Access", "Audit Trail", "Admin Logs"]
    },
    {
        title: "Process & Workflow",
        icon: FiBriefcase,
        items: ["Request Handling", "Approvals", "Document Routing", "Checkpoints", "Multi-Step Workflows"]
    },
    {
        title: "Compliance & Records",
        icon: FiFileText,
        items: ["Policies", "Regulatory Docs", "Version Control", "Access Logs", "Compliance Reports"]
    }
];
...
const HRMSAdminIntegrationStack = () => {
    const navigate = useNavigate();

    return (
        <div className="w-full text-white">
            <Helmet>
                <title>HRMS & Admin Portal | Optimize HR & Admin Workflows</title>
                <meta
                    name="description"
                    content="Streamline human resources and administrative processes with secure, scalable HRMS and Admin Portal integration solutions."
                />
            </Helmet>
            ...
            <div className="absolute z-0 h-full w-full border-0 border-amber-50 hidden flex-col justify-center items-center animate-pulse md:flex">
                <div className="border-40 md:border-100 border-purple-500 rounded-full h-[900vh] w-[80vw] md:h-[400vh] md:w-[80vw] opacity-40 animate-pulse flex flex-col justify-center items-center">
                    <div className="border-30 md:border-80 border-purple-700 rounded-full h-[750vh] w-[60vw] md:h-[325vh] md:w-[60vw]  opacity-40 flex flex-col justify-center items-center">
                        <div className="border-20 md:border-60 border-purple-800 rounded-full h-[900vh] w-[40vw] md:h-[275vh] md:w-[40vw] opacity-40"></div>
                    </div>
                </div>
            </div>
            ...
            <div className="relative w-full flex flex-col items-center px-4 py-20">
                <div className="text-center mb-12 max-w-5xl">
                    <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-400 via-white to-gray-400 bg-clip-text text-transparent mb-4 unbounded p-2">
                        Smart <span className="px-4 rounded-full bg-gradient-to-br from-purple-500 via-purple-400 to-purple-500 text-white">HRMS</span> & Admin Portals
                    </h1>

                    <p className="text-lg text-gray-300">
                        Enhance employee experience and administrative control with secure HRMS and Admin Portal integration.
                    </p>
                </div>
            ...
            <div className="w-full py-10 px-4 sm:px-6 lg:px-8">
                ...
                {renderStackGrid(adminPortalStack)}
            </div>
                ...
                <div className="w-full max-w-3xl p-8 bg-gradient-to-br from-purple-700 via-indigo-600 to-purple-800 rounded-3xl shadow-xl border border-white/10 relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                            Ready to Modernize HR & Admin Operations?
                        </h2>
                        <p className="text-gray-200 mb-6">
                            Unlock efficient HR and administrative management with tailored HRMS and Admin Portal integrations — automate, centralize, and secure every part of your back office with confidence.
                        </p>
                        <button
...
export default HRMSAdminIntegrationStack;
