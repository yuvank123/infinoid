...
const IoTSmartSystems = () => {
  ...
  return (
    <>
      <Helmet>
        <title>IoT & Smart System Solutions</title>
        <meta
          name="description"
          content="Develop smart systems with IoT technology for automation, data collection, and real-time decision making. Empower homes, industries, and cities with intelligent connectivity."
        />
      </Helmet>
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 py-10 sm:py-16 md:py-40 bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-xl w-full gap-12 lg:gap-20 md:mb-40">
          <div className="flex-1 text-center md:text-left space-y-6">
            ...
            >
              Intelligent <span className="text-purple-300">IoT</span> & Connected <span className="text-purple-300">Smart Systems</span>
            </h1>
