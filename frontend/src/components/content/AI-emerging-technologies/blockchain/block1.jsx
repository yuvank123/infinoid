...
const BlockchainArchitecture = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Blockchain Architecture & Decentralized Solutions</title>
        <meta
          name="description"
          content="Build secure, decentralized, and scalable blockchain infrastructure for financial systems, supply chains, token economies, and beyond."
        />
      </Helmet>
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 py-10 sm:py-16 md:py-40 bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-xl w-full gap-12 lg:gap-20 md:mb-40">
          <div className="flex-1 text-center md:text-left space-y-6">
            ...
            >
              Scalable <span className="text-purple-300">Blockchain Architecture</span> for Web3 Era
            </h1>
